    ...
    <div>
      ...
      <div className="navbar-Container">
        ...
        <div className="navbar-Links">
          <a className={`navbar-Link ${active === "home" ? "active" : ""}`} onClick={() => setActive("home")} href="#">Home</a>
          ...
          <a className={`navbar-Link ${active === "about" ? "active" : ""}`} onClick={() => setActive("about")} href="#">About</a>
